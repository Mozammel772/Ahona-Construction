      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5  py-10 px-5" id="construction">
        <div className="card  bg-white shadow-xl">
          <figure className="px-2 pt-2">
            <img src={bricks} alt="Shoes" className="h-[200px] w-[200px] rounded-xl" />
          </figure>
        ...
        <div className="card  bg-white shadow-xl">
          <figure className="px-2 pt-2">
            <img src={balu} alt="Shoes" className="h-[200px] w-[200px] rounded-xl" />
          </figure>
          <div className="card-body">
        ...
        <div className="card  bg-white shadow-xl">
          <figure className="px-2 pt-2">
            <img src={cement} alt="Shoes" className="h-[200px] w-[200px] rounded-xl" />
          </figure>
          <div className="card-body ">
        ...
        <div className="card  bg-white shadow-xl">
          <figure className="px-2 pt-2">
            <img src={ispat} alt="Shoes" className="h-[200px] w-[200px] rounded-xl" />
          </figure>
          <div className="card-body ">
        ...
        <div className="card  bg-white shadow-xl">
          <figure className="px-2 pt-2">
            <img src={sectionbalu} alt="Shoes" className="h-[200px] w-[200px] rounded-xl" />
          </figure>
          <div className="card-body ">
        ...
        <div className="card  bg-white shadow-xl">
          <figure className="px-2 pt-2">
            <img src={allcons} alt="Shoes" className="h-[200px] w-[200px] rounded-xl" />
          </figure>
          <div className="card-body ">
        ...
        <div className="card  bg-white shadow-xl">
          <figure className="px-2 pt-2">
            <img src={banner1} alt="Shoes" className="h-[200px] w-[200px] rounded-xl" />
          </figure>
          <div className="card-body ">
        ...
        <div className="card  bg-white shadow-xl">
          <figure className="px-2 pt-2">
            <img src={banner2} alt="Shoes" className="h-[200px] w-[200px] rounded-xl" />
          </figure>
          <div className="card-body ">
